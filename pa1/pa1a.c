...
void Main ()
{
	...
	Printf ("I am the parent, my first Getpid is %d\n", Getpid());
	Printf ("I am the parent, my first pid is %d\n", pid);

	if ((pid = Fork ()) == 0) {

		/* child executes here */

		Printf ("I am the child, my Getpid is %d\n", Getpid ());
		Exit ();
	}


	Printf ("I am the parent, my Getpid is %d\n", Getpid ());
	// Printf ("I am the parent, my returned pid is %d\n", pid);
	...
	if ((pid = Fork ()) == 0) {
		...
		Printf ("I am the second child, my Getpid is %d\n", Getpid ());
		Exit ();
	}

	Printf ("I just created another child process whose pid is %d\n", pid);
}
