									...
									if (Fork () == 0) {
										...
										if (Fork () == 0) {
											...
											if (Fork () == 0) {
												...
												SlowPrintf (5, "13 13");	/* process 13 */
												Exit ();
											}

											SlowPrintf (5, "12 12");	/* process 12 */
											Exit ();
										}

										SlowPrintf (5, "11 11");	/* process 11 */
										Exit ();
									}

									SlowPrintf (5, "101010");	/* process 10 */
									Exit ();
								}

								SlowPrintf (5, "999");	/* process 9 */
								Exit ();
							}

							SlowPrintf (5, "888");	/* process 8 */
							Exit ();
						}

						SlowPrintf (5, "777");	/* process 7 */
						Exit ();
					}

					SlowPrintf (5, "666");	/* process 6 */
					Exit ();
				}

				SlowPrintf (5, "555");	/* process 5 */
				Exit ();
			}

			SlowPrintf (5, "444");	/* process 4 */
			Exit ();
		}

		SlowPrintf (5, "333");		/* process 2 */
		Exit ();
	}

	// if (Fork () == 0) {

	// 	SlowPrintf (5, "12 12");		/* process 3 */
	// 	Exit ();
	// }
	// if (Fork () == 0) {

	// 	SlowPrintf (5, "11 11");		/* process 3 */
	// 	Exit ();
	// }
	// if (Fork () == 0) {

	// 	SlowPrintf (5, "10 10");		/* process 3 */
	// 	Exit ();
	// }
	// if (Fork () == 0) {

	// 	SlowPrintf (5, "999");		/* process 3 */
	// 	Exit ();
	// }
	// if (Fork () == 0) {

	// 	SlowPrintf (5, "888");		/* process 3 */
	// 	Exit ();
	// }
	// if (Fork () == 0) {

	// 	SlowPrintf (5, "777");		/* process 3 */
	// 	Exit ();
	// }
	// if (Fork () == 0) {

	// 	SlowPrintf (5, "666");		/* process 3 */
	// 	Exit ();
	// }
	// if (Fork () == 0) {

	// 	SlowPrintf (5, "555");		/* process 3 */
	// 	Exit ();
	// }
	// if (Fork () == 0) {

	// 	SlowPrintf (5, "444");		/* process 3 */
	// 	Exit ();
	// }
	// if (Fork () == 0) {

	// 	SlowPrintf (5, "333");		/* process 3 */
	// 	Exit ();
	// }

	if (Fork () == 0) {

		SlowPrintf (5, "222");		/* process 3 */
		Exit ();
	}

	SlowPrintf (5, "111");			/* process 1 */
	Exit ();
}
