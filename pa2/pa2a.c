 ...
 *
 * delay must be between 0 and 9
 * 0 and 9 have no delays -> 8 is the largest delay time with vidisble effects
 *
 ...
 * 
 * (4 is the smallest and 8 is the largest)
 * smallest unit of change = 100/8 = 12.5 msecs
 */
